...
winget install --id Zoom.ZoomOutlookPlugin --scope machine -a x64 -h --accept-package-agreements --authentication-mode silent --authentication-account SYSTEM --accept-source-agreements --force --verbose --disable-interactivity
winget install --id Zoom.ZoomSkypeForBusinessPlugin --scope machine -a x64 -h --accept-package-agreements --authentication-mode silent --authentication-account SYSTEM --accept-source-agreements --force --verbose --disable-interactivity
winget install --id Zoom.ZoomRemoteControl --scope machine -a x64 -h --accept-package-agreements --authentication-mode silent --authentication-account SYSTEM --accept-source-agreements --force --verbose --disable-interactivity
...
winget install --id VideoLAN.VLC --scope machine -a x64 -h --accept-package-agreements --authentication-mode silent --authentication-account SYSTEM --accept-source-agreements --force --verbose --disable-interactivity
winget install --id Microsoft.DotNet.Framework.DeveloperPack_4 --scope machine -a x64 -h --accept-package-agreements --authentication-mode silent --authentication-account SYSTEM --accept-source-agreements --force --verbose --disable-interactivity
winget install --id Microsoft.DotNet.Framework.Runtime --scope machine -a x64 -h --accept-package-agreements --authentication-mode silent --authentication-account SYSTEM --accept-source-agreements --force --verbose --disable-interactivity
